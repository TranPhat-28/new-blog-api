...
export class Migration20260114131346_add_comment_entity extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table "comment" ("id" uuid not null default gen_random_uuid(), "content" text not null, "post_id" uuid not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, constraint "comment_pkey" primary key ("id"));`);
